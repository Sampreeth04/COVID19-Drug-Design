...
parser.add_argument('--max_epochs', required=False, default=80, help="The max number of epochs for training")
...
def main():
    ...
    train(max_epochs, model, optimizer, scheduler, train_loader, valid_loader, test_loader, project_name)
